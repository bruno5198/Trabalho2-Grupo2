         ...
         #   print(Fore.YELLOW + Style.BRIGHT + 'Drawing circle.' + Style.RESET_ALL)
          #  circleX = last_coordinates[0]
           # circleY = last_coordinates[1]
            ...
            #r = int(math.sqrt((circleX - all_coordinates[i][0]) ** 2 + (circleY - all_coordinates[i][1]) ** 2))
            #cv2.circle(white_window, (circleX, circleY), r, (0, 0, 255), 0)
            #print("CIrcleX: " + str(circleX))
            #print("CircleY: " + str(circleY))
            #print("Radius: " + str(r))
